...
public fun main() {
    ...
    com.varabyte.kobweb.core.init.initKobweb(router) { ctx ->
        ctx.router.register("/") { com.honger.ngel.pages.homePage() }
    ...
    com.varabyte.kobweb.silk.init.additionalSilkInitialization = { ctx ->
        ...
        ctx.theme.registerStyle("about-image", com.honger.ngel.style.AboutImageStyle)
        ctx.theme.registerStyle("about-text", com.honger.ngel.style.AboutTextStyle)
        ctx.theme.registerStyle("back-to-top-button", com.honger.ngel.style.BackToTopButtonStyle)
        ctx.theme.registerStyle("input", com.honger.ngel.style.InputStyle)
        ctx.theme.registerStyle("portfolio-section", com.honger.ngel.style.PortfolioSectionStyle)
        ctx.theme.registerStyle("portfolio-arrow-icon",
                com.honger.ngel.style.PortfolioArrowIconStyle)
        ctx.theme.registerStyle("service-card", com.honger.ngel.style.ServiceCardStyle)
        ctx.theme.registerStyle(com.honger.ngel.style.NavigationStyle)
        ctx.theme.registerStyle(com.honger.ngel.style.LogoStyle)
        ctx.theme.registerStyle(com.honger.ngel.style.SocialLinkStyle)
        ctx.theme.registerStyle(com.honger.ngel.style.MainButtonStyle)
        ctx.theme.registerStyle(com.honger.ngel.style.MainImageStyle)
    }
    ...
    AppGlobals.initialize(mapOf("title" to "LandingPage"))
    renderComposable(rootElementId = "root") {
        com.honger.ngel.appEntry {
