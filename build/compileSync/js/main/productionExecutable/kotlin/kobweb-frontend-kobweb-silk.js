(function (root, factory) {
  ...
  var setSilkWidgetVariables = kotlin_com_varabyte_kobweb_silk_widgets.$_$.f;
  var prepareSilkFoundation = kotlin_com_varabyte_kobweb_silk_foundation.$_$.o1;
  ...
  function SilkApp(content, $composer, $changed) {
    ...
    $composer_0 = $composer_0.s1a(921272959);
    var $dirty = $changed;
    if (($changed & 14) === 0)
    ...
    if (tmp0_safe_receiver == null)
      ...
      tmp0_safe_receiver.t1f(SilkApp$lambda_0(content, $changed));
    }
  }
