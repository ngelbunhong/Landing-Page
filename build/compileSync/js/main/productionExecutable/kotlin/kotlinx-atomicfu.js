(function (root, factory) {
  ...
  protoOf(AtomicRef).eh = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).fh = function () {
  ...
  protoOf(AtomicBoolean).gh = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).fh = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicInt).hh = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).fh = function () {
    return this.kotlinx$atomicfu$value;
  };
