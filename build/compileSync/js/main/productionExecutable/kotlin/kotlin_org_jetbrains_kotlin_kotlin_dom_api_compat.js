(function (root, factory) {
  ...
  function hasClass(_this__u8e3s4, cssClass) {
    ...
    return Regex_init_$Create$(this_1).qb(this_0);
  }
  function removeClass(_this__u8e3s4, cssClasses) {
    ...
    if (tmp$ret$1) {
      ...
      var this_2 = Regex_init_$Create$('\\s+').ub(this_1, 0);
  ...
  protoOf(EventListenerHandler).dh = function (event) {
    this.ch_1(event);
  };
  ...
  protoOf(EventListenerHandler).toString = function () {
    return 'EventListenerHandler(' + toString(this.ch_1) + ')';
  };
