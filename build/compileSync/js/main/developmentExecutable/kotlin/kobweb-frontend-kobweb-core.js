(function (root, factory) {
  ...
  var trimStart = kotlin_kotlin.$_$.le;
  ...
  var A = kotlin_org_jetbrains_compose_html_html_core.$_$.l5;
  ...
  var dropLast = kotlin_kotlin.$_$.fd;
  ...
  function Anchor(href, attrs, openInternalLinksStrategy, openExternalLinksStrategy, updateHistoryMode, autoPrefix, content, $composer, $changed, $default) {
    ...
    var $composer_0 = $composer;
    $composer_0 = $composer_0.startRestartGroup_lebv1i_k$(-2106898385);
    var $dirty = $changed;
    if (!(($default & 1) === 0))
      $dirty = $dirty | 6;
    ...
    if (!(($default & 64) === 0))
      ...
      $dirty = $dirty | ($composer_0.changedInstance_s1wkiy_k$(content_0._v) ? 1048576 : 524288);
    if (!(($dirty & 2995931) === 599186) || !$composer_0.get_skipping_3owdve_k$()) {
      if (!(($default & 2) === 0)) {
        attrs_0._v = null;
      }
      if (!(($default & 4) === 0)) {
    ...
    if (tmp0_safe_receiver == null)
      ...
      tmp0_safe_receiver.updateScope_t8jcf_k$(Anchor$lambda_0(href, attrs_0, openInternalLinksStrategy_0, openExternalLinksStrategy_0, updateHistoryMode_0, autoPrefix_0, content_0, $changed, $default));
    }
  }
