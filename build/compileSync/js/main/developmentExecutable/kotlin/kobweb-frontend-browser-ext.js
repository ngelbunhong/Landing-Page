(function (root, factory) {
  ...
  var split = kotlin_kotlin.$_$.xd;
  var compareTo = kotlin_kotlin.$_$.pa;
  var repeat = kotlin_kotlin.$_$.ud;
  ...
  var isLowerCase = kotlin_kotlin.$_$.nd;
  ...
  initMetadataForCoroutine($getBodyBytesCOROUTINE$1, CoroutineImpl);
  ...
  function ResponseException(response, bodyBytes) {
    ...
    var tmp12_safe_receiver = bodyBytes == null ? null : decodeToString(bodyBytes);
    var tmp;
    if (tmp12_safe_receiver == null) {
      tmp = null;
    } else {
      // Inline function 'kotlin.text.trim' call
      tmp = toString(trim(isCharSequence(tmp12_safe_receiver) ? tmp12_safe_receiver : THROW_CCE()));
    }
    var tmp13_safe_receiver = tmp;
    var tmp_0;
    if (tmp13_safe_receiver == null) {
      ...
      if (!isBlank(tmp13_safe_receiver)) {
        tmp_1 = tmp13_safe_receiver;
      } else {
        tmp_1 = null;
      }
      tmp_0 = tmp_1;
    ...
    if (!(bodyString == null)) {
      ...
      var longestLineLength = tmp0_elvis_lhs == null ? 0 : tmp0_elvis_lhs;
      var indent = '  ';
