(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', './compose-multiplatform-core-compose-runtime-runtime.js', './kotlin-kotlin-stdlib.js', './kobweb-frontend-kobweb-compose.js', './html-html-core.js', './kobweb-frontend-browser-ext.js', './kobweb-frontend-compose-html-ext.js', './kotlin_org_jetbrains_kotlin_kotlin_dom_api_compat.js'], factory);
    ...
    root['kobweb-frontend-silk-foundation'] = factory(typeof this['kobweb-frontend-silk-foundation'] === 'undefined' ? {} : this['kobweb-frontend-silk-foundation'], this['compose-multiplatform-core-compose-runtime-runtime'], this['kotlin-kotlin-stdlib'], this['kobweb-frontend-kobweb-compose'], this['html-html-core'], this['kobweb-frontend-browser-ext'], this['kobweb-frontend-compose-html-ext'], kotlin_org_jetbrains_kotlin_kotlin_dom_api_compat);
  }
}(globalThis, function (_, kotlin_org_jetbrains_compose_runtime_runtime, kotlin_kotlin, kotlin_com_varabyte_kobweb_kobweb_compose, kotlin_org_jetbrains_compose_html_html_core, kotlin_com_varabyte_kobweb_browser_ext, kotlin_com_varabyte_kobweb_compose_html_ext, kotlin_org_jetbrains_kotlin_kotlin_dom_api_compat) {
  'use strict';
  ...
  var flatMap = kotlin_kotlin.$_$.xc;
  var filter = kotlin_kotlin.$_$.wc;
  var Sequence = kotlin_kotlin.$_$.uc;
  var isInterface = kotlin_kotlin.$_$.ob;
  var map = kotlin_kotlin.$_$.zc;
  var toSet_0 = kotlin_kotlin.$_$.bd;
  ...
  var trimMargin = kotlin_kotlin.$_$.ke;
  var media = kotlin_org_jetbrains_compose_html_html_core.$_$.p4;
  ...
  var substringAfterLast = kotlin_kotlin.$_$.ae;
  ...
  var StyleScopeBuilder = kotlin_org_jetbrains_compose_html_html_core.$_$.d3;
  ...
  var throwKotlinNothingValueException = kotlin_kotlin.$_$.fg;
  ...
  function Keyframes$usesColorMode$delegate$lambda(this$0) {
    return function () {
      return !Companion_getInstance_4().isColorModeAgnostic_fn4jgj_k$(this$0.init_1);
    };
  }
  ...
  function toModifier(_this__u8e3s4, variants, $composer, $changed) {
    ...
    var tmp = toModifier_1(_this__u8e3s4.cssStyle_1, $composer_0, 0);
    var tmp2_safe_receiver = combine(toList(variants), $composer_0, 8);
    var tmp0_elvis_lhs = tmp2_safe_receiver == null ? null : tmp2_safe_receiver.toModifier_wob29e_k$($composer_0, 0);
  ...
  function toModifier_0(_this__u8e3s4, $composer, $changed) {
    var $composer_0 = $composer;
    $composer_0.startReplaceableGroup_ip860b_k$(-842703364);
  ...
  function ComposableSingletons$DeferredKt() {
    ...
    var tmp = this;
    tmp.lambda_1_r8sbbp_1 = ComposableLambda$invoke$ref(composableLambdaInstance(-452891088, false, ComposableSingletons$DeferredKt$lambda_1$lambda_ynev9p));
  }
  ...
  protoOf(CssStyle).addStylesInto_avvx4p_k$ = function (selector, styleSheet, layer) {
    ...
    var tmp7_safe_receiver = lightModifiers.get_wei43m_k$(Companion_getInstance_10().get_BaseKey_nx9788_k$());
    var tmp_0 = tmp7_safe_receiver == null ? null : tmp7_safe_receiver.get_modifier_t1pq5c_k$();
    var tmp8_safe_receiver = darkModifiers.get_wei43m_k$(Companion_getInstance_10().get_BaseKey_nx9788_k$());
  ...
  protoOf(ImmutableCssStyle).toModifier_7iov47_k$ = function ($composer, $changed) {
    ...
    while (tmp0_iterator.hasNext_bitz1p_k$()) {
      ...
      var tmp$ret$1 = Companion_getInstance_12().get_current_2iudd5_k$($composer_0, 6).get_opposite_ywslzk_k$().get_name_woqyms_k$().toLowerCase();
  ...
  function ExtendingCssStyle$_init_$lambda_m2ritn($extraModifier, $baseStyle) {
    return function ($composer, $changed) {
      ...
      var tmp0 = $extraModifier($composer_0, 0).then_mmfvo6_k$(toModifier_1($baseStyle, $composer_0, 0));
      $composer_0.endReplaceableGroup_ern0ak_k$();
      return tmp0;
    };
  }
  ...
  protoOf(SimpleCssStyleVariant).toModifier_wob29e_k$ = function ($composer, $changed) {
    ...
    var tmp0 = toModifier_2(this.cssStyle_1, [], $composer_0, 64);
    $composer_0.endReplaceableGroup_ern0ak_k$();
    return tmp0;
  };
  ...
  function not(_this__u8e3s4, params) {
    return Companion_getInstance_7().OfFunctionalPseudoClass_j2u724_k$(_this__u8e3s4, 'not', params.slice());
  }
  ...
  function toPx(_this__u8e3s4) {
    ...
    var tmp0_elvis_lhs = tmp28_safe_receiver == null ? null : tmp28_safe_receiver.toPx_24esj_k$();
  ...
  function rememberBreakpoint($composer, $changed) {
    var $composer_0 = $composer;
    $composer_0.startReplaceableGroup_ip860b_k$(1660417661);
    var tmp = get_breakpointFloor(window);
    $composer_0.startReplaceableGroup_ip860b_k$(-662005520);
    // Inline function 'androidx.compose.runtime.cache' call
    // Inline function 'kotlin.let' call
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
    ...
    $composer_0.endReplaceableGroup_ern0ak_k$();
    var tmp0 = produceState(tmp, tmp1_group, $composer_0, 64).get_value_j01efc_k$();
    $composer_0.endReplaceableGroup_ern0ak_k$();
    return tmp0;
  }
  ...
  function rootColorModeState$delegate$lambda() {
    _init_properties_ColorMode_kt__lz79sc();
    return mutableStateOf(Companion_getInstance_6().get_Instance_ljxvgi_k$().get_initialColorMode_i1z52t_k$());
  }
  ...
  _.$_$.l1 = suffixedWith;
  _.$_$.m1 = clip;
  _.$_$.n1 = modifyStyleBase;
  _.$_$.o1 = get_name_0;
  _.$_$.p1 = prepareSilkFoundation;
  _.$_$.q1 = Breakpoint_LG_getInstance;
  _.$_$.r1 = Breakpoint_MD_getInstance;
  _.$_$.s1 = Breakpoint_SM_getInstance;
  _.$_$.t1 = Breakpoint_XL_getInstance;
  _.$_$.u1 = Breakpoint_ZERO_getInstance;
  _.$_$.v1 = Base_init_$Init$;
  _.$_$.w1 = RectF_init_$Create$_2;
  _.$_$.x1 = Companion_getInstance_8;
  _.$_$.y1 = Companion_getInstance_12;
  _.$_$.z1 = Blue_getInstance;
  _.$_$.a2 = Gray_getInstance;
  _.$_$.b2 = Red_getInstance;
  //endregion
  return _;
}));
